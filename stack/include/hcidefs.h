...
#define HCI_READ_SECURE_CONN_HOST_SUPPORT       (0x0079 | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_SECURE_CONN_HOST_SUPPORT      (0x007A | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_AUTH_PAYLOAD_TOUT              (0x007B | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_AUTH_PAYLOAD_TOUT             (0x007C | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_LOCAL_OOB_EXTENDED_DATA        (0x007D | HCI_GRP_HOST_CONT_BASEBAND_CMDS)

#define HCI_WRITE_SEC_CONN_TEST_MODE            (0x000A | HCI_GRP_TESTING_CMDS)
...
#if (defined(BTM_SECURE_CONN_HOST_INCLUDED) && BTM_SECURE_CONN_HOST_INCLUDED == TRUE)
/* Definitions for Write Secure connection Host support */
#define HCI_SECURE_CONN_HOST_DISABLED    0x00
#define HCI_SECURE_CONN_HOST_ENABLED     0x01
#endif
...
#if (defined(BTM_SECURE_CONN_HOST_INCLUDED) && BTM_SECURE_CONN_HOST_INCLUDED == TRUE)
#define HCI_LKEY_TYPE_UNAUTH_COMB_P256  0x07
#define HCI_LKEY_TYPE_AUTH_COMB_P256    0x08
#endif
...
#if (defined(BTM_SECURE_CONN_HOST_INCLUDED) && BTM_SECURE_CONN_HOST_INCLUDED == TRUE)
#define HCI_FEATURE_SECURE_CONN_HOST_MASK 0x08
#define HCI_FEATURE_SECURE_CONN_HOST_OFF  0
#define HCI_SECURE_CONN_HOST_SUPPORTED(x) ((x)[HCI_FEATURE_SECURE_CONN_HOST_OFF] & HCI_FEATURE_SECURE_CONN_HOST_MASK)

#define HCI_FEATURE_SECURE_CONN_CTRL_MASK 0x01
#define HCI_FEATURE_SECURE_CONN_CTRL_OFF  1
#define HCI_SECURE_CONN_CTRL_SUPPORTED(x) ((x)[HCI_FEATURE_SECURE_CONN_CTRL_OFF] & HCI_FEATURE_SECURE_CONN_CTRL_MASK)
#endif
